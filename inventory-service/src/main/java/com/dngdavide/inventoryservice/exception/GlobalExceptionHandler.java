...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleNotFound(InventoryItemNotFoundException ex) {
    ...
    public ResponseEntity<ErrorResponse> handleDuplicate(DuplicateInventoryItemException ex) {
